...
import com.popant.baseweb.base.service.IGenericService;
 ...
 */
public abstract class GenericServiceImpl<Model, PK> implements IGenericService<Model, PK> {
     ...
     */
    public abstract IGenericMapper<Model, PK> getMapper();
