package com.popant.basewebapp.base.controller;

import com.alibaba.fastjson.JSONArray;
import com.popant.baseweb.base.controller.BaseController;
...
import com.popant.baseweb.base.util.EncryptUtil;
...
public class UserController extends BaseController {
    ...
    public String dologin(UserInfo userInfo, HttpSession session,HttpServletRequest request ,Integer remember) {
        ...
        UsernamePasswordToken token = new UsernamePasswordToken(
                userInfo.getUserName(), EncryptUtil.encryptMD5(userInfo.getPassword()));
        ...
        if (currentUser.isAuthenticated()) {
            ...
            String jsonMenuList = userMenuService.getJsonMenuList(userInfo.getUserId(), userInfo.getEnterpriseId());
    ...
    public String doregister(UserInfo userInfo, HttpSession session,HttpServletRequest request) {
        ...
        userInfo.setPassword(EncryptUtil.encryptMD5(userInfo.getPassword()));
    ...
    public String doalterpass(UserInfo userInfo, HttpSession session,HttpServletRequest request) {
        ...
        if(!password.equals(EncryptUtil.encryptMD5(request.getParameter("originPassword")))){
        ...
        String newPassword = EncryptUtil.encryptMD5(userInfo.getPassword());
    ...
    public String doforget(UserInfo userInfo, HttpSession session,HttpServletRequest request) {
        ...
        userInfo.setPassword(EncryptUtil.encryptMD5("123456"));
//        userInfo.setUserType(UserType.CUSTOM_USER);
        int i = userInfoService.updateUserPassword(userInfo);
